var snData = {
	...
	detailed:{
		...
		parameter: [''],
		shineComment: ['名称： 羊咩咩暖水袋  & 内容： 羊羊暖水袋一个（ 水电分离） & 材质： 超短绒毛（ 内填充PP棉) & 颜色： 棕色 & 充电情况： 通电时指示灯亮， 充电完成后指示灯灭， 发出滴滴的声音拔下电源即可 &最高温度： 70 度 &特别提示：（ 本产品已注好水后再进行配送） 请保持充电接口的干燥， 充电时请勿使用！ 儿童请在家长监护下使用！&包装： 精美包装'],
		seek: {
			seekAll: [{
				seekTitle: 'US00004C37C',
				time: '2015-04-09 19:55:14',
				textContent: '盆友很喜欢~ 说很实用'
			}, {
				seekTitle: 'US000052E06  ',
				time: '2015-02-04 23:26:24',
